...
class CocktailEditorForm extends Component {
    state = {
        title: '',
        image: '',
        recipe: '',
    ...
    componentDidMount = () => {
        this.props.getOneCocktail(this.props.match.params.id).then(response => {
            this.setState({title: response.cocktail.title,
                image: response.cocktail.image,
                recipe: response.cocktail.recipe,
                ingredients: response.cocktail.ingredients})
        });
    ...
    submitFormHandler = event => {
        ...
        this.props.saveCocktailChanges(this.props.match.params.id, formData);
    };
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        saveCocktailChanges: (id, oneCocktailData) => dispatch(saveCocktailChanges(id,oneCocktailData))
    }
};
export default connect(mapStateToProps, mapDispatchToProps)(CocktailEditorForm);
